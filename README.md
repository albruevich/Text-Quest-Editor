...
2. **Режим переходов**  
   ...
   *Примечание: первая и вторая локации могут совпадать.*
...
Локации могут быть разных типов: Нейтральная, Стартовая, Победная, Провальная, Пустая. 
...
**Провальная** - на ней квест завершается победной. 
